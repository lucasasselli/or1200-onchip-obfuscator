...
set CORE_PATH = ../../fusesoc/cores/or1200-obf/rtl/verilog
set SYS_PATH = ../../fusesoc/systems/or1200-obf-generic/bench/verilog/include
...
# Obfuscator
analyze -library WORK -format verilog $CORE_PATH/obf_lut0.v
analyze -library WORK -format verilog $CORE_PATH/obf_pt0.v
analyze -library WORK -format verilog $CORE_PATH/obf_sublut.v
analyze -library WORK -format verilog $CORE_PATH/obf_indexgen.v
analyze -library WORK -format verilog $CORE_PATH/obf_insngen.v
analyze -library WORK -format verilog $CORE_PATH/obf_rndgen.v
analyze -library WORK -format verilog $CORE_PATH/obf_keydec.v
analyze -library WORK -format verilog $CORE_PATH/obf_top.v
